...
- One spec file per class/module. For each class or module under `lib/`, keep all of its unit tests in a single spec file under `spec/` that mirrors the path and file name exactly: `lib/debug_logging/my_class.rb` -> `spec/debug_logging/my_class_spec.rb`.
...
[🤝conduct]: https://gitlab.com/pboling/debug_logging/-/blob/main/CODE_OF_CONDUCT.md
