...
gem_version =
  if RUBY_VERSION >= "3.1" # rubocop:disable Gemspec/RubyVersionGlobalsUsage
    ...
    Module.new.tap { |mod| Kernel.load("#{__dir__}/lib/debug_logging/version.rb", mod) }::DebugLogging::Version::VERSION
  else
...
"
  ...
  spec.metadata["homepage_uri"] = "https://debug-logging.galtzo.com/"
  ...
  # The 'git' gem is optional; debug_logging falls back to shelling out to `git` if it is not present.
